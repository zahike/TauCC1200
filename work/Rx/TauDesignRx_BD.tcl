...
proc create_root_design { parentCell } {
  ...
  # Create instance: CC1200SPI_Top_0, and set properties
  set block_name CC1200SPI_Top
  set block_cell_name CC1200SPI_Top_0
  if { [catch {set CC1200SPI_Top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CC1200SPI_Top_0 eq "" } {
  ...
  connect_bd_net -net CC1200SPI_Top_0_Out_Off_Link [get_bd_pins CC1200SPI_Top_0/Out_Off_Link] [get_bd_pins RxMem_0/Out_Off_Link]
  ...
  connect_bd_net -net RxHDMI_0_Mem_Read [get_bd_pins RxHDMI_0/Mem_Read] [get_bd_pins RxMem_0/HMemRead] [get_bd_pins ila_1/probe2]
  connect_bd_net -net RxHDMI_0_Out_pData [get_bd_pins RxHDMI_0/Out_pData] [get_bd_pins rgb2dvi_0/vid_pData]
  connect_bd_net -net RxHDMI_0_Out_pHSync [get_bd_pins RxHDMI_0/Out_pHSync] [get_bd_pins ila_1/probe5] [get_bd_pins rgb2dvi_0/vid_pVSync]
  connect_bd_net -net RxHDMI_0_Out_pVDE [get_bd_pins RxHDMI_0/Out_pVDE] [get_bd_pins RxMem_0/pVDE] [get_bd_pins ila_1/probe3] [get_bd_pins rgb2dvi_0/vid_pVDE]
  ...
  connect_bd_net -net RxMem_0_DeHDMIadd [get_bd_pins RxMem_0/DeHDMIadd] [get_bd_pins ila_1/probe0]
  ...
  connect_bd_net -net RxMem_0_HDMIdata [get_bd_pins RxHDMI_0/Mem_Data] [get_bd_pins RxMem_0/HDMIdata] [get_bd_pins ila_1/probe1]
  connect_bd_net -net RxSyncPic_0_PixelClk [get_bd_pins RxHDMI_0/clk] [get_bd_pins RxMem_0/PixelClk] [get_bd_pins ila_1/probe4] [get_bd_pins rgb2dvi_0/PixelClk]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins CC1200SPI_Top_0/clk] [get_bd_pins RxMem_0/Cclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rgb2dvi_0/SerialClk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins CC1200SPI_Top_0/rstn] [get_bd_pins RxHDMI_0/rstn] [get_bd_pins RxMem_0/rstn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins rgb2dvi_0/aRst_n]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins CC1200SPI_Top_0/FraimSync] [get_bd_pins CC1200SPI_Top_0/GetDataEn] [get_bd_pins CC1200SPI_Top_0/TranFrame] [get_bd_pins xlconstant_0/dout]
